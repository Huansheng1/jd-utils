...
const fs = require('fs')
const $ = new Env('京喜牧场');
let cookiesArr = [], cookie = '', notify, shareCodes = ['9Cg5OVNAWgjJfxcHZaXfOk1V4yPa3smmNLXbkhnBClsc-bmgUMDCqkfCPfba7C04', '9Cg5OVNAWgjJfxcHZaXfOnehVK_VIfZnbb2ge0Eyl6Oc0w1HC0azUcuLd7NUZ8FU', '9Cg5OVNAWgjJfxcHZaXfOjvciPyLEvRd8FWKcu5og_BxZKAEKMfaSNx8JwGz7IkS', '9Cg5OVNAWgjJfxcHZaXfOo2e_Gxthf361a-PjFVsLa4'];
